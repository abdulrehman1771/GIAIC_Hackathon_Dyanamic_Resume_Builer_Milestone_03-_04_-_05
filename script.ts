...
document.getElementById('formEmail')?.addEventListener('input', function () {
    ...
    const errorMessage = <HTMLElement>document.getElementById('errorMessage');
...
formSubmitButton?.addEventListener('click', ()=>{
    ...
    if (validateEmail(email) && niche && name1){
        ...
        function returnGreaterForTwo(a:NodeListOf<Element>, b:NodeListOf<Element>){
        ...
        for (let element = 0; element < returnGreaterForTwo(formInstitutes, formQualifications).length; element++) {
            ...
            const formQualificationValue = (<HTMLInputElement>formQualifications[element]).value;
            cvBElement.append(formQualificationValue);
            const formInstituteValue = (<HTMLInputElement>formInstitutes[element]).value;
        ...
        function returnGreaterForThree(a:NodeListOf<Element>, b:NodeListOf<Element>, c:NodeListOf<Element>){
        ...
        for (let element = 0; element < returnGreaterForThree(formYear, formCompany, formPosition).length; element++) {
            ...
            const formYearValue = (<HTMLInputElement>formYear[element]).value
            cvYearElement.append(formYearValue)
            
            const formCompanyValue = (<HTMLInputElement>formCompany[element]).value
            cvCompanyElement.append(formCompanyValue)

            const formPositionValue = (<HTMLInputElement>formPosition[element]).value
